...
# AIRPORTS DATAFRAME CONTAINS THE FOLLOWING COLUMNS:
# - AIRPORT NAME
# - LATITUDE IN DEGREES
# - LONGITUDE IN DEGREES
# - IATA CODE
#
# THIS DATAFRAME IS USED TO CREATE AVINOR_KEPLER FOR VISUALIZATION
# IN KEPLERGL AND LEAFLET MAPS
...
# df_airport_monthly_traffic IS A DATAFRAME CONTAINING MONTHLY AIRPORT TRAFFIC DATA WITH THE FOLLOWING COLUMNS:
# - DATE
# - AIRPORT_ICAO_CODE
# - ARRIVAL_DEPARTURE
...
# - SEATS
#
# ADDITIONAL COLUMNS (MERGED FROM AIRPORT_CODE VIA JOIN USING AIRPORT ICAO CODE):
# - IATA_CODE
# - ISO_COUNTRY
# - NAME
#
# THIS JOIN IS USED TO ALIGN AIRPORT IDENTIFIERS WITH AVINOR_DATA VIA COMMON IATA_CODE
```
```{python}
...
# DF_AVINOR_KEPLER CONTAINS FLIGHT ROUTE DATA USED FOR VISUALIZATION IN KEPLERGL AND LEAFLET MAPS
...
#
# ENRICHED AIRPORT INFORMATION (JOINED FROM AIRPORTS DATAFRAME):
...
# - ARR_LON: ARRIVAL AIRPORT LONGITUDE
...
# FINAL COLUMNS IN DF_AVINOR:

# - date_time (from df_avinor_all; combined date and time of flight)
# - departure_airport_iata (from df_avinor_all)
# - arrival_airport_iata (from df_avinor_all)
# - airline_designator_iata (from df_avinor_all)
# - seats (from df_avinor_all)
# - passengers (from df_avinor_all)
# - flights (from df_avinor_all)

# DEPARTURE AIRPORT FIELDS (from df_airports_code, suffix "_departure"):
# - icao_code_departure (from airports_code)
# - iata_code_departure (from airports_code)
# - iso_country_departure (from airports_code)
# - name_departure (from airports_code)

# ARRIVAL AIRPORT FIELDS (from df_airports_code, suffix "_arrival"):
# - icao_code_arrival (from airports_code)
# - iata_code_arrival (from airports_code)
# - iso_country_arrival (from airports_code)
# - name_arrival (from airports_code)
```
...
###### Column {width=50%}
```{python}
# SHOWS DESTINATION FOR LAST MONTH FROM AVINOR
